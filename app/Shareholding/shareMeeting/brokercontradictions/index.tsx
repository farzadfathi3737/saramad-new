...
const BrokerContradictions = () => {
    ...
    useEffect(() => {
        const setdata = async () => {
            let _model = await getEntityModel('brokercontradictions');
            setModel(_model);
        };
                                            ...
                                            <div className="flex items-center justify-center pr-3">
                                                {fileList.length > 0 ? (
                                                    <div className="flex cursor-pointer items-center justify-center rounded-lg border-2 border-dashed border-gray-300 p-2 text-center">
                                                        <i className="fa-duotone fa-solid fa-xmark text-base m-1 pl-5 text-gray-500 cursor-pointer" onClick={() => setUploadedFiles([])} />
                                                        <ul>{fileList}</ul>
                                                    </div>
                                                ) : (
                                                    <i className="fa-duotone fa-solid fa-cloud-arrow-up text-2xl m-1 text-gray-500" />
                                                )}
                                            </div>
                                        </div>
                                    </div>
