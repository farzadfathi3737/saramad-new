                            ...
                            >
                                <Form>
                                    <div className="grid w-full grid-cols-1 gap-2 sm:grid-cols-2">
                                        <div className="grid w-full grid-cols-1 gap-2 sm:grid-cols-2">
                                            <div>
                                                <label className="text-white-dark">{t('investmentType')}</label>
                                                <div className="form-input bg-white-light pt-3 text-white-dark">{data.investmentTypeName}</div>
                                            </div>
                                            <div>
