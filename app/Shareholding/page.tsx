  ...
  return (
    <div className="flex min-h-screen flex-row w-full">
      ...
      <div className="flex w-full flex-col">
        <div className="justify-items-center border-b py-2" style={{ backgroundColor: 'var(--color-header-bg)', borderColor: 'var(--color-border)' }}>
          <div
          ...
          <div className={`flex flex-row justify-between gap-2.5 w-full pl-6 ${isOpen ? "pr-12" : "pr-3"}`}>
            ...
            >
              <img className="ml-[5px] w-[150px] flex-none dark:hidden" src="/assets/images/logo.png" alt="logo" />
              <img className="ml-[5px] w-[150px] flex-none hidden dark:block" src="/assets/images/logo-white.png" alt="logo" />
            </div>
            <div>
              <ChangeCompany />
            </div>
            ...
            <div className="flex flex-row justify-center items-center gap-2">
              <button
                type="button"
                className="p-0 bg-transparent h-[42px] w-[42px] flex items-center justify-center rounded-full"
              >
                <i className="fa-duotone fa-solid fa-envelope text-xl text-gray-400 hover:text-[#2691bf]" />
              </button>
              <button
                type="button"
                className="p-0 bg-transparent h-[42px] w-[42px] flex items-center justify-center rounded-full"
              ...
              <DarkThemeToggle className="p-0 h-[42px] w-[42px] flex items-center justify-center rounded-full bg-transparent text-gray-400 hover:text-[#2691bf] focus:ring-0" />

              <div className="flex justify-center items-center">
                <div className="flex cursor-pointer" onClick={() => setIsOpenUser(true)}>
                  <div className="pl-2 h-full">
                    <button
                      type="button"
                      className="p-0 bg-transparent h-[42px] w-[42px] flex rounded-full justify-center items-center"
                    >
                      <i className="fa-duotone fa-solid fa-circle-user text-4xl text-gray-400" />
                    </button>
                  </div>
                  <div className="text-base flex flex-col" style={{ color: 'var(--color-text)' }}>
                    <div className="text-base pb-1">سید محسن الهامی</div>
                    <span className="rounded w-fit bg-green-200 px-1 text-xs text-green-600">پشتیبان</span>
                  </div>
                </div>
                <Drawer open={isOpenUser} onClose={handleClose}>
                  <DrawerItems>
                    <div className="flex justify-between items-center mb-4">
                      <div style={{ color: 'var(--color-text)' }}>اطلاعات کاربر</div>
                      <div onClick={handleClose} className="cursor-pointer">
                        <i className="fa-duotone fa-solid fa-xmark text-xl text-gray-500" />
                      </div>
                    </div>
                    <DarkThemeToggle />
                  </DrawerItems>
        ...
        <div className="h-full justify-items-center p-2" style={{ backgroundColor: 'var(--color-page-bg)' }}>
