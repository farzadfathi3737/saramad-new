...
const Add = () => {
    ...
    const SignupSchema = Yup.object().shape({
        industryId: Yup.string().required(t('required').toString()),
                            ...
                            <Form>
                                <div className="grid w-full grid-cols-1 gap-2 sm:grid-cols-2">
                                    <div className="w-full">
                                        <Field id="industryId" name="industryId" label={t('industry')} listRefName="stockindustry" component={FSelectModelField} />
                                    </div>
