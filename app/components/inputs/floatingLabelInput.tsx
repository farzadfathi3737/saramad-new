...
const FloatingLabelInput: React.FC<InputProps> = ({
  ...
  return (
    <div className={`relative w-full ${className && className}`}>
      ...
      <label
        className={`text-lable pointer-events-none absolute -translate-y-2/4 transform text-xs text-gray-600 transition-all duration-200 ${field.value || hasValue || isFocused || value
