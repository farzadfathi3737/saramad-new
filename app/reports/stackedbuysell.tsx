                ...
                <div className="table-responsive p-5">
                    {model && (
                        <Demo
                            ...
                            addSepratorFildes={['volumeSum', 'bourseAgencyCommissionSum', 'bourseCompanyCommissionSum', 'bourseITCommissionSum', 'bourseRayanCommissionSum', 'brokerCommissionDiscountSum', 'brokerCommissionSum', 'brokerCostWithoutDiscountSum', 'costBenefit', 'depositoryCommissionSum', 'grossCostSum', 'grossPriceAverage', 'netPriceAverage', 'netSellCostSum', 'otherCommissionsSum', 'primeCostSum', 'primePriceAverage', 'taxSum', 'totalCosts', 'volumeSum']}
                            addFooterSumFildes={['volumeSum', 'bourseAgencyCommissionSum', 'bourseCompanyCommissionSum', 'bourseITCommissionSum', 'bourseRayanCommissionSum', 'brokerCommissionDiscountSum', 'brokerCommissionSum', 'brokerCostWithoutDiscountSum', 'costBenefit', 'depositoryCommissionSum', 'grossCostSum', 'grossPriceAverage', 'netPriceAverage', 'netSellCostSum', 'otherCommissionsSum', 'primeCostSum', 'primePriceAverage', 'taxSum', 'totalCosts', 'volumeSum']}
                            labaleNameList={[
